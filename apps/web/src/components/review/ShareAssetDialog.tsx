...
type Props = {
    ...
    assetTitle?: string;
    assetVersion?: number;
    onCreateLink?: (options: { expiresAt: Date | null; allowDownload: boolean }) => Promise<string>;
                            ...
                            <div className="rounded-xl border border-border/60 bg-gradient-to-br from-muted/50 to-muted/20 p-4">
                                <div className="space-y-3">
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            <p className="text-sm font-medium">Locked to version {assetVersion}</p>
                                            <p className="text-xs text-muted-foreground">Future changes won't affect this link</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
